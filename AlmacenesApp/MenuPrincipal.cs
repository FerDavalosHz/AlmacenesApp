    ...
    public partial class MenuPrincipal : Form
    {
        ...
        private void MenuPrincipal_Load(object sender, EventArgs e)
        {
            ...
            foreach (var permiso in _usuario.Permisos)
            {
                ...
                {
                    TsUsuarios.Enabled = permiso.PermisoLeerAbrir || permiso.PermisoEscritura;
                    if (permiso.PermisoEscritura) Escritura = 1;
                }
                else if (permiso.NombreModulo.Equals("productos", StringComparison.OrdinalIgnoreCase))
                {
                    TProductos.Enabled = permiso.PermisoLeerAbrir || permiso.PermisoEscritura;
                }
            }
